...
async def auto_post():
    ...
    try:
        text_prompt = f"Напиши унікальний, професійний і цікавий пост для Telegram каналу NEXARA. Рубрика: {selected['theme']}. Суть: {selected['desc']}. Мова: українська. Використовуй абзаци та емодзі. Максимум 900 символів. Жодних хештегів."
...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(auto_post, 'interval', hours=12)
    scheduler.start()
    yield
    polling_task.cancel()
    scheduler.shutdown()
